...
using System.Linq;
namespace FiasService.XmlStruct
{
    ...
    public partial class ActualStatuses
    {
        ...
        public IEnumerable<DataSruct.ActualStatus> Build() { return ActualStatus.Select<ActualStatusesActualStatus, DataSruct.ActualStatus>(x => x.Build()); }
    ...
    public partial class ActualStatusesActualStatus
    {
        ...
        public DataSruct.ActualStatus Build() { return new DataSruct.ActualStatus {  ACTSTATID = int.Parse(aCTSTATIDField), NAME = nAMEField }; }
    ...
    public partial class AddressObjects
    {
        ...
        public IEnumerable<DataSruct.AddressObjects> Build() {
            var filter = Object.Where(e => e.REGIONCODE.Equals("23") || e.REGIONCODE.Equals("01"));
            return filter.Select<AddressObjectsObject, DataSruct.AddressObjects>(x => x.Build());
        }

        public IEnumerable<DataSruct.DellAddressObjects> DellBuild() {
            var filter = Object.Where(e => e.REGIONCODE.Equals("23") || e.REGIONCODE.Equals("01"));
            return filter.Select<AddressObjectsObject, DataSruct.DellAddressObjects>(x => x.DellBuild());
        }
    ...
    public partial class AddressObjectsObject
    {
        ...
        public DataSruct.AddressObjects Build() { return new DataSruct.AddressObjects {
        ...
        public DataSruct.DellAddressObjects DellBuild()
        {
            return new DataSruct.DellAddressObjects
            {
    ...
    public partial class CenterStatuses
    {
        ...
        public IEnumerable<DataSruct.CenterStatuses> Build() { return CenterStatus.Select<CenterStatusesCenterStatus, DataSruct.CenterStatuses>(x => x.Build()); }
    }
    ...
    public partial class CenterStatusesCenterStatus
    {
        ...
        public DataSruct.CenterStatuses Build() { return new DataSruct.CenterStatuses { CENTERSTID = int.Parse(cENTERSTIDField),NAME = nAMEField }; }
        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute(DataType = "integer")]
    ...
    public partial class CurrentStatuses
    {
        ...
        public IEnumerable<DataSruct.CurrentStatuses> Build() { return CurrentStatus.Select<CurrentStatusesCurrentStatus, DataSruct.CurrentStatuses>(x => x.Build()); }
    }
    ...
    public partial class CurrentStatusesCurrentStatus
    {
        ...
        public DataSruct.CurrentStatuses Build() { return new DataSruct.CurrentStatuses { CURENTSTID = int.Parse(cURENTSTIDField), NAME = nAMEField }; }
    ...
    public partial class EstateStatuses
    {
        ...
        public IEnumerable<DataSruct.EstateStatuses> Build() { return EstateStatus.Select<EstateStatusesEstateStatus, DataSruct.EstateStatuses>(x => x.Build()); }
    }
    ...
    public partial class EstateStatusesEstateStatus
    {
        ...
        public DataSruct.EstateStatuses Build() { return new DataSruct.EstateStatuses { ESTSTATID = byte.Parse(eSTSTATIDField), NAME = nAMEField, SHORTNAME = sHORTNAMEField }; }
    ...
    public partial class Houses
    {
        ...
        public IEnumerable<DataSruct.Houses> Build() { return houseField.Select<HousesHouse, DataSruct.Houses>(x => x.Build()); }
        public IEnumerable<DataSruct.DellHouses> DellBuild() { return houseField.Select<HousesHouse, DataSruct.DellHouses>(x => x.DellBuild()); }
    }
    ...
    public partial class HousesHouse
    {
        ...
        public DataSruct.Houses Build() { return new DataSruct.Houses {
        ...
        public DataSruct.DellHouses DellBuild()
        {
            return new DataSruct.DellHouses
            {
                HOUSEID = new Guid(HOUSEID),
                HOUSEGUID = new Guid(HOUSEGUID),
                AOGUID = new Guid(AOGUID),
    ...
    public partial class HouseIntervals
    {
        ...
        public IEnumerable<DataSruct.HouseIntervals> Build() { return HouseInterval.Select<HouseIntervalsHouseInterval, DataSruct.HouseIntervals>(x => x.Build()); }
        public IEnumerable<DataSruct.DellHouseIntervals> DellBuild() { return HouseInterval.Select<HouseIntervalsHouseInterval, DataSruct.DellHouseIntervals>(x => x.DellBuild()); }
    }
    ...
    public partial class HouseIntervalsHouseInterval
    {
        ...
        public DataSruct.HouseIntervals Build()
        {
            return new DataSruct.HouseIntervals
            {
        ...
        public DataSruct.DellHouseIntervals DellBuild()
        {
            return new DataSruct.DellHouseIntervals
            {
                HOUSEINTID = new Guid(HOUSEINTID),
                AOGUID = new Guid(AOGUID),
                COUNTER = int.Parse(COUNTER),
    ...
    public partial class HouseStateStatuses
    {
        ...
        public IEnumerable<DataSruct.HouseStateStatuses> Build() { return HouseStateStatus.Select<HouseStateStatusesHouseStateStatus, DataSruct.HouseStateStatuses>(x => x.Build()); }
    }
    ...
    public partial class HouseStateStatusesHouseStateStatus
    {
        ...
        public DataSruct.HouseStateStatuses Build() { return new DataSruct.HouseStateStatuses { HOUSESTID = int.Parse(hOUSESTIDField), NAME = nAMEField }; }
    ...
    public partial class IntervalStatuses
    {
        ...
        public IEnumerable<DataSruct.IntervalStatuses> Build() { return IntervalStatus.Select<IntervalStatusesIntervalStatus, DataSruct.IntervalStatuses>(x => x.Build()); }
    ...
    public partial class IntervalStatusesIntervalStatus
    {
        ...
        public DataSruct.IntervalStatuses Build() { return new DataSruct.IntervalStatuses {INTVSTATID = int.Parse(iNTVSTATIDField), NAME = nAMEField }; }
    ...
    public partial class Landmarks
    {
        ...
        public IEnumerable<DataSruct.Landmarks> Build() { return landmarkField.Select<LandmarksLandmark, DataSruct.Landmarks>(x => x.Build()); }
    ...
    public partial class LandmarksLandmark
    {
        ...
        public DataSruct.Landmarks Build()
        {
          return  new DataSruct.Landmarks
            {
    ...
    public partial class NormativeDocumentTypes
    {
        ...
        public IEnumerable<DataSruct.NormativeDocumentTypes> Build() { return NormativeDocumentType.Select<NormativeDocumentTypesNormativeDocumentType, DataSruct.NormativeDocumentTypes>(x => x.Build()); }
    }
    ...
    public partial class NormativeDocumentTypesNormativeDocumentType
    {
        ...
        public DataSruct.NormativeDocumentTypes Build() { return new DataSruct.NormativeDocumentTypes { NDTYPEID = int.Parse(NDTYPEID), NAME = nAMEField }; }
    ...
    public partial class NormativeDocumentes
    {
        ...
        public IEnumerable<DataSruct.NormativeDocument> Build() { return NormativeDocument.Select<NormativeDocumentesNormativeDocument, DataSruct.NormativeDocument>(x => x.Build()); }
        public IEnumerable<DataSruct.DellNormativeDocument> DellBuild() { return NormativeDocument.Select<NormativeDocumentesNormativeDocument, DataSruct.DellNormativeDocument>(x => x.DellBuild()); }
    }
    ...
    public partial class NormativeDocumentesNormativeDocument
    {
        ...
        public DataSruct.NormativeDocument Build() {
            return new DataSruct.NormativeDocument
            {
        ...
        public DataSruct.DellNormativeDocument DellBuild()
        {
            return new DataSruct.DellNormativeDocument
            {
                NORMDOCID = new Guid(NORMDOCID),
                DOCDATE = DOCDATE,
                DOCIMGID = DOCIMGID == null ? new int?() : int.Parse(DOCIMGID),
    ...
    public partial class OperationStatuses
    {
        ...
        public IEnumerable<DataSruct.OperationStatuses> Build() { return OperationStatus.Select<OperationStatusesOperationStatus, DataSruct.OperationStatuses>(x => x.Build()); }
    }
    ...
    public partial class OperationStatusesOperationStatus
    {
        ...
        public DataSruct.OperationStatuses Build() { return new DataSruct.OperationStatuses { OPERSTATID = int.Parse(oPERSTATIDField), NAME = nAMEField }; }
    ...
    public partial class AddressObjectTypes
    {
        ...
        public IEnumerable<DataSruct.AddressObjectTypes> Build() { return AddressObjectType.Select<AddressObjectTypesAddressObjectType, DataSruct.AddressObjectTypes>(x => x.Build()); }
    }
    ...
    public partial class AddressObjectTypesAddressObjectType
    {
        ...
        public DataSruct.AddressObjectTypes Build() { return new DataSruct.AddressObjectTypes { KOD_T_ST = kOD_T_STField, SOCRNAME = sOCRNAMEField, SCNAME = sCNAMEField, LEVEL = int.Parse(lEVELField) }; }
    ...
    public partial class StructureStatuses
    {
        ...
        public IEnumerable<DataSruct.StructureStatuses> Build() { return StructureStatus.Select<StructureStatusesStructureStatus, DataSruct.StructureStatuses>(x => x.Build()); }
    }
    ...
    public partial class StructureStatusesStructureStatus
    {
        ...
        public DataSruct.StructureStatuses Build() { return new DataSruct.StructureStatuses {STRSTATID = int.Parse(sTRSTATIDField), NAME = nAMEField, SHORTNAME = sHORTNAMEField }; }
